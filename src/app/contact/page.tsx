...
export const metadata: Metadata = {
  title: "Contact Us",
  description:
    "Contact the TypeWarp support team for help with our cursed text generator, glitch font tools, or technical inquiries. We are here to assist you.",
  keywords: [
    "contact typewarp",
      ...
      <div className="mx-auto px-4 sm:px-6 max-w-6xl relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-start">
          ...
          <div className="flex-1 w-full lg:sticky lg:top-32">
            ...
            <div className="space-y-4 max-w-sm">
              <a
                ...
                className="group flex items-center gap-4 p-5 bg-white dark:bg-[#0a0a0a] border border-neutral-200 dark:border-white/5 rounded-2xl hover:border-accent-glitch/30 transition-all duration-300 relative overflow-hidden shadow-sm dark:shadow-none"
              >
              ...
              <div className="group flex items-center gap-4 p-5 bg-white dark:bg-[#0a0a0a] border border-neutral-200 dark:border-white/5 rounded-2xl relative overflow-hidden shadow-sm dark:shadow-none">
                <div className="w-12 h-12 bg-neutral-100 dark:bg-[#111] border border-neutral-200 dark:border-white/10 rounded-xl flex items-center justify-center shrink-0">
                  <Clock className="w-5 h-5 text-neutral-400 dark:text-white/40" />
                </div>
                <div>
                  <h3 className="text-[10px] font-mono text-text-muted uppercase tracking-[0.2em] font-bold mb-1">
                    Response Time
                  </h3>
                  <p className="text-sm md:text-base text-text-primary font-bold">
                    Within 24 Hours
                  </p>
                </div>
              </div>
          ...
          <div className="flex-[1.2] w-full">
            <div className="bg-white dark:bg-[#080808] border border-neutral-200 dark:border-white/10 rounded-[2rem] p-6 sm:p-8 md:p-12 shadow-2xl relative overflow-hidden w-full">
        ...
        <div className="mt-16 sm:mt-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
            <div className="p-5 md:p-6 bg-white dark:bg-[#0c0c0c] border border-neutral-200 dark:border-white/5 rounded-xl shadow-sm dark:shadow-none">
              <h3 className="text-sm font-black uppercase tracking-wider text-text-primary mb-3">
                Technical Support
              </h3>
          ...
          <div className="p-6 md:p-8 bg-white dark:bg-[#0c0c0c] border border-neutral-200 dark:border-white/5 rounded-xl mb-8 shadow-sm dark:shadow-none">
