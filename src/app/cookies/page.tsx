    ...
    <div className="min-h-screen pt-6 lg:pt-8 pb-16 sm:pb-20 bg-bg-void text-text-primary relative overflow-hidden">
      ...
      <div className="mx-auto px-4 sm:px-6 max-w-4xl relative z-10">
        ...
        <nav className="flex items-center gap-2 mb-4 lg:mb-6 font-mono text-[10px] sm:text-xs uppercase tracking-[0.2em] text-text-muted">
          ...
          <span className="text-emerald-600 dark:text-accent-glitch">Cookies</span>
        </nav>
        ...
        <section className="mb-12 sm:mb-16">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-black mb-4 sm:mb-6 tracking-tight uppercase leading-[0.9]">
            ...
            <span className="text-emerald-600 dark:text-accent-glitch">Policy</span>
          </h1>
        ...
        <div className="flex items-center gap-4 p-4 sm:p-5 mb-12 sm:mb-16 bg-accent-glitch/5 border border-accent-glitch/20 rounded-xl max-w-2xl">
          <Cookie className="w-6 h-6 sm:w-8 sm:h-8 text-emerald-600 dark:text-accent-glitch shrink-0" />
              ...
              <div className="flex flex-col gap-4">
                ...
                <div>
                  <div className="flex items-center gap-3 mb-2">
                    <span className="text-[10px] font-mono text-emerald-600 dark:text-accent-glitch/50 font-bold">
                      {String(index + 1).padStart(2, "0")}
                    </span>
                    <h2 className="text-sm sm:text-base font-bold text-text-primary uppercase tracking-wide group-hover:text-emerald-600 dark:text-accent-glitch transition-colors">
                      {section.title}
                    </h2>
                  </div>
