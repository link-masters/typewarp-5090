      ...
      <div className="mx-auto px-4 sm:px-6 max-w-4xl relative z-10">
        ...
        <section className="mb-12 sm:mb-16 bg-bg-card/30 border border-neutral-200 dark:border-white/[0.04] p-6 sm:p-10 rounded-3xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8 text-sm text-text-muted leading-relaxed">
            <div className="space-y-2">
              <h3 className="text-text-primary font-bold uppercase tracking-wider text-xs">
        ...
        <section className="mb-12 sm:mb-16">
          ...
          <div className="mt-8 p-5 sm:p-6 bg-accent-glitch/5 border border-accent-glitch/20 rounded-2xl">
            <p className="text-xs sm:text-sm text-neutral-600 dark:text-white/80 leading-relaxed font-mono uppercase tracking-wide">
