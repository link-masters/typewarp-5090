    ...
    <Link href={`/blog/${post.slug}`} className="group block h-full">
      <article className="flex flex-col sm:flex-row items-stretch gap-4 md:gap-5 bg-[#0c0c0c] border border-white/5 p-4 md:p-5 rounded-xl md:rounded-2xl hover:border-accent-glitch/20 transition-all duration-500 h-full relative overflow-hidden">
        ...
        <div className="flex-grow flex flex-col justify-center min-w-0 py-1">
          <div className="flex items-center gap-2 md:gap-3 text-[10px] font-mono mb-3 md:mb-4 uppercase tracking-[0.2em] text-white/50">
          ...
          <p className="text-xs md:text-sm text-white/60 leading-relaxed line-clamp-2 group-hover:text-white/80 transition-colors duration-500">
            {post.description}
          </p>

          <div className="mt-4 md:mt-5 flex items-center justify-between">
            <div className="flex items-center gap-2 text-white/40 group-hover:text-accent-glitch font-mono font-bold text-[10px] uppercase tracking-[0.2em] transition-colors duration-300">
              Read More
