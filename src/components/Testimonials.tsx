...
export default function Testimonials() {
  return (
    <section className="py-16 md:py-20 lg:py-24 bg-neutral-50 dark:bg-[#080808] relative overflow-hidden border-t border-neutral-200 dark:border-white/5">
      {/* Ambient Glow — dark only */}
      <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_50%_0%,rgba(57,255,20,0.02)_0%,transparent_50%)] pointer-events-none hidden dark:block" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6">
          {testimonials.map((t, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="p-6 md:p-6 lg:p-8 bg-white dark:bg-[#0c0c0c] shadow-sm dark:shadow-none border border-neutral-200 dark:border-white/5 rounded-2xl md:rounded-3xl hover:border-emerald-500/20 dark:hover:border-accent-glitch/20 transition-all duration-500 group relative overflow-hidden"
            >
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 md:w-11 md:h-11 rounded-full border border-neutral-200 dark:border-white/10 flex items-center justify-center overflow-hidden relative bg-neutral-100 dark:bg-[#111]">
                  <User className="w-5 h-5 text-neutral-400 dark:text-white/40" />
                </div>
                <div>
                  <div className="text-xs md:text-sm font-black text-neutral-900 dark:text-white uppercase tracking-wider">
                    {t.name}
                  </div>
                  <div className="text-[9px] md:text-[10px] text-neutral-400 dark:text-white/30 font-mono uppercase tracking-widest mt-0.5">
                    {t.role}
                  </div>
                </div>
              </div>
