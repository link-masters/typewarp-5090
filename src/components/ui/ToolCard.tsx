    ...
    >
      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        <div>
          ...
          <p className="text-text-muted text-[11px] font-mono leading-relaxed mb-6 group-hover:text-text-primary transition-colors">
            {description}
          </p>
        </div>
        ...
        <div className="mt-auto pt-5 border-t border-border-subtle flex items-center justify-between">
          ...
          <div className="text-[9px] font-mono text-text-muted group-hover:text-text-muted transition-colors uppercase tracking-widest">
            Ready to Use
          </div>
        </div>
      </div>
