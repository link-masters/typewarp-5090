...
image: "/blog/style-fancy-hero.png"
...
Extra Thicc Text Generator works by converting ASCII to Fullwidth forms (U+FF01 to U+FF5E). Unlike traditional fonts (like .ttf or .otf files) which change the _design_ of the characters but require the user to have the font file installed, our generator uses **Unicode mapping**.
