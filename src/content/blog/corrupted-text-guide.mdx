...
image: "/blog/dark-horror-hero.png"
category: "Dark & Horror"
author: "TypeWarp Team"
tags:
  ["corrupted text", "data rot", "bit rot", "file corruption", "broken text"]
---
...
Corrupted Text Generator works by injecting random "noise" characters and broken symbols. Unlike traditional fonts (like .ttf or .otf files) which change the _design_ of the characters but require the user to have the font file installed, our generator uses **Unicode mapping**.
