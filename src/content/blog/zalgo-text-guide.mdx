...
Zalgo Text Generator works by combining diacritical marks that span upwards and downwards. Unlike traditional fonts (like .ttf or .otf files) which change the _design_ of the characters but require the user to have the font file installed, our generator uses **Unicode mapping**.
