...
Creepy Text Generator works by using widely spaced, jagged, or "shaky" looking Unicode glyphs. Unlike traditional fonts (like .ttf or .otf files) which change the _design_ of the characters but require the user to have the font file installed, our generator uses **Unicode mapping**.
